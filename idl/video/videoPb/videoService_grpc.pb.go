...
const (
	VideoService_Feed_FullMethodName        = "/videoService.VideoService/Feed"
	VideoService_Publish_FullMethodName     = "/videoService.VideoService/Publish"
	VideoService_PublishList_FullMethodName = "/videoService.VideoService/PublishList"
)
...
func (c *videoServiceClient) Publish(ctx context.Context, in *PublishRequest, opts ...grpc.CallOption) (*PublishResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedVideoServiceServer) Publish(context.Context, *PublishRequest) (*PublishResponse, error) {
